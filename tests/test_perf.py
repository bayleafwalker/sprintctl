...
class TestDbSizeGrowth:
    ...
    def test_schema_tables_count(self, conn):
        ...
        expected = {"sprint", "track", "work_item", "event", "claim", "ref", "dep", "schema_version", "maintenance_capability", "maintenance_capability_receipt", "maintenance_capability_recovery"}
