"""Context and handoff presentation contracts.

Kept separate from the portable record protocol so session/render consumers do
not grow the event-envelope boundary.
"""
